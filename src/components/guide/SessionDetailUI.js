    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {people.coach && (
                    <>
                        <GoldenTemplate enrollmentId = {session.enrollmentId} memberId= {people.member.user.id} sessionUserId={people.coach.sessionUser.id} apiProxy={this.props.appStore.apiProxy} />
